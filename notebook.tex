...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}58}]:} \PY{k}{def} \PY{n+nf}{init\PYZus{}fig}\PY{p}{(}\PY{p}{)}\PY{p}{:}
...
transformed.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}59}]:} \PY{k}{def} \PY{n+nf}{x\PYZus{}func1}\PY{p}{(}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}60}]:} \PY{n}{fig}\PY{p}{,}\PY{n}{ax}\PY{p}{,}\PY{n}{line} \PY{o}{=} \PY{n}{init\PYZus{}fig}\PY{p}{(}\PY{p}{)} 
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}61}]:} \PY{n}{fig}\PY{p}{,}\PY{n}{ax}\PY{p}{,}\PY{n}{line} \PY{o}{=} \PY{n}{init\PYZus{}fig}\PY{p}{(}\PY{p}{)} 
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}61}]:} <matplotlib.animation.FuncAnimation at 0x1d20a4b1f28>
\end{Verbatim}
